...
def main():
    ...
    Processes all files in outputs/script_outputs/tag_extractor_batch-summaries/
    """
    
    print("="*70)
    print("🏷️  BATCH UPDATE: MongoDB Summaries Tags")
    print("="*70)
    ...
    try:
        ...
        print(f"📊 Collection: kitab-prod-tables.summaries")
    except Exception as e:
        print(f"❌ Connection failed: {e}")
        return
    
    # Find all JSON/TXT files in the directory
    json_folder = os.path.join(project_root, "outputs/script_outputs/tag_extractor_batch-summaries")
